...
const OrderHistory = () => {
    ...
    return (
        <div className="space-y-4">
            <h3 className="font-bold text-xl mb-4">Your Orders</h3>
            {[...orders].reverse().map((order) => (
                <Card key={order.id} className="p-4 border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex justify-between items-start mb-2">
                        <div>
                            <span className="font-bold text-brand-maroon">#{order.id}</span>
                    ...
                    <div className="flex justify-between items-center text-sm font-medium">
                        ...
                        <div className="space-x-2">
                            <button className="text-brand-maroon hover:underline">View Details</button>
                            ...
                            {activeTab === 'details' && (
                                <Card className="p-6">
                                    ...
                                    <form className="space-y-4">
                                        ...
                                        <Button disabled variant="secondary">Update Details</Button>
                                    </form>
                                </Card>
                            )}
                        </motion.div>
