...
import { updateStock, toggleAvailability, fetchInventory } from './adminInventorySlice';
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4 md:mb-6">
                ...
                <button
                    onClick={() => navigate('/admin/products/add', { state: { from: 'inventory' } })}
                    className="w-full md:w-auto bg-brand-mahogany text-white px-4 py-2.5 md:py-2 rounded-lg text-sm font-medium hover:bg-brand-mahogany/90 transition-colors shadow-sm active:scale-95"
                >
                    + Add New Product
                </button>
            </div>
                ...
                <div className="hidden md:block overflow-x-auto bg-white rounded-xl border border-gray-100 md:border-0">
                    <table className="w-full text-left">
                        <thead className="bg-gray-50 text-gray-600 font-semibold text-sm">
                            <tr>
                                <th className="md:px-3 md:py-3 lg:px-6 lg:py-4 whitespace-nowrap min-w-[150px] lg:min-w-0">Product Name</th>
                                <th className="md:px-3 md:py-3 lg:px-6 lg:py-4 whitespace-nowrap">Category</th>
                                <th className="md:px-3 md:py-3 lg:px-6 lg:py-4 whitespace-nowrap">Status</th>
                                <th className="md:px-3 md:py-3 lg:px-6 lg:py-4 whitespace-nowrap">Stock Level</th>
                                <th className="md:px-3 md:py-3 lg:px-6 lg:py-4 text-center whitespace-nowrap">Availability</th>
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {items.map((item) => (
                                <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                                    <td className="md:px-3 md:py-3 lg:px-6 lg:py-4 font-medium text-gray-900 whitespace-nowrap">{item.name}</td>
                                    <td className="md:px-3 md:py-3 lg:px-6 lg:py-4 text-gray-500 whitespace-nowrap">{item.category}</td>
                                    ...
                                    <td className="md:px-3 md:py-3 lg:px-6 lg:py-4 text-center whitespace-nowrap">
                                    ...
                                    <td className="md:px-3 md:py-3 lg:px-6 lg:py-4 text-right whitespace-nowrap">
