...
import { toggleActive, deleteProduct, fetchProducts } from './adminProductsSlice';
                ...
                <div className="hidden md:block overflow-x-auto">
                    <table className="w-full text-left">
                        <thead className="bg-gray-50 text-gray-600 text-xs uppercase font-semibold">
                            <tr>
                                <th className="md:px-3 md:py-3 lg:px-6 lg:py-4 whitespace-nowrap min-w-[200px] lg:min-w-0">Product</th>
                                <th className="md:px-3 md:py-3 lg:px-6 lg:py-4 whitespace-nowrap">Category</th>
                                <th className="md:px-3 md:py-3 lg:px-6 lg:py-4 whitespace-nowrap">Price / Weight</th>
                                <th className="md:px-3 md:py-3 lg:px-6 lg:py-4 whitespace-nowrap">Stock Status</th>
                                <th className="md:px-3 md:py-3 lg:px-6 lg:py-4 text-center whitespace-nowrap">Status</th>
